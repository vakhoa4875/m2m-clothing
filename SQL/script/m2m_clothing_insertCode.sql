...
values
(1,'Hanes mens Ecosmart Hoodie',16.26,1083012,'"FLEECE TO FEEL GOOD ABOUT - Hanes EcoSmart men`s hoodie is made with cotton sourced from American farms. 
...
MADE TO LAST - Double-needle stitching at the neck and armholes for added sturdiness."',4.5,180502,361004,'1-1.jpg,1-2.jpg,1-3.jpg','1.mp4','hanes-mens-ecosmart-hoodie',1),

(2,'Fruit of the Loom Eversoft Fleece Hoodies',35.76,353118,'"Male Model is 6’0” wearing a Size Medium. 
...
Ribbed cuffs and waistband that hold their shape Shoulder-to-shoulder neck tape for comfort and durability"',4.6,58853,117706,'2-1.jpg,2-2.jpg,2-3.jpg','2.mp4','fruit-of-the-loom-eversoft-fleece-hoodies',1),

(3,'Gildan Fleece Hoodie Sweatshirt',18.42,724074,'preshrunk 50% cotton/50% dryblend polyester moisture-wicking fabric air-jet yarn for softer feel and no pilling double-lined hood with matching drawstring double-needle stitching',4.7,120679,241358,'3-1.jpg,3-2.jpg,3-3.jpg','3.mp4','gildan-fleece-hoodie-sweatshirt',1),
...
SPOT THE C - This raincoat features the iconic C logo at the wrist. Note: C logo patch color may vary from image."',4.6,5874,11748,'5-1.jpg,5-2.jpg,5-3.jpg','5.mp4','champion-mens-jacket',1),
...
BUILT TO LAST: Columbia’s attention to detail is what sets our apparel apart. Specifying only the highest quality materials, expert stitching and craftsmanship. This is a long-lasting jacket you will enjoy for seasons to come."',4.4,1064,2128,'6-1.jpg,6-2.jpg,6-3.jpg',NULL,'columbia-mens-flashback-windbreaker',1),
...
For 40 years and three generations, we have been guided by our roots. Inspired by the change of seasons, and the abundance of natural beauty around us, Charles River Apparel creates timeless styles that weather the elements as well as the trends"',4.6,1886,3772,'7-1.jpg,7-2.jpg,7-3.jpg','7.mp4','charles-river-apparel-pack-n-go-windbreaker-pullover-hooded-jacket',1),

(8,'Tommy Hilfiger Women`s Casual Band Jacket',109.5,2328,'"Classic Tommy Hilfiger style: If you’re into blazer jackets for women perfect for fall no need to look further; with brass-style buttons and band style fashion detailing, this jacket is a fashion statement must-have for any wardrobe 
...
Fall into Winter: Add a sweater under your jacket when it gets cold; on your feet, wear booties for women with pants, knee high boots with skinnies or a classic pair of high heeled pumps to complete the look for day or night"',4.4,388,776,'8-1.jpg,8-2.jpg,8-3.jpg',NULL,'tommy-hilfiger-womens-casual-band-jacket',1),
...
Year-round luxury: Wear a coat over these women’s blazer in the winter, cardigan in the spring and summer or wear them to relax around the home"',4.5,220,440,'9-1.jpg,9-2.jpg',NULL,'calvin-klein-womens-one-button-lux-blazer',1),

(10,'Calvin Klein Women`s Two Button Lux Blazer (Petite, Standard, & Plus)',99,8736,'"Lapel collar 
Flap pockets"',4.3,1456,2912,'10-1.jpg,10-2.jpg,10-3.jpg',NULL,'calvin-klein-womens-two-button-lux-blazer-petite-standard-plus',1),
...
Rugged metal zipper and zipper pull for a durable and stylish look"',4.7,40,80,'11-1.jpg,11-2.jpg,11-3.jpg',NULL,'mens-duck-work-vest',1),
...
BUILT TO LAST: Columbia’s attention to detail is what sets our apparel apart. Specifying only the highest quality materials, expert stitching and craftsmanship. This is a long-lasting vest you will enjoy for seasons to come"',4.2,57,114,'12-1.jpg,12-2.jpg,12-3.jpg',NULL,'columbia-mens-steens-mountain-vest',1),
...
Comfort and style: This men’s vest is sure to become a staple in your closet; bring it along in your work bag, wear it for a night out, on vacation or as part of your daily outfit"',4.6,609,1218,'13-1.jpg,13-2.jpg,13-3.jpg',NULL,'calvin-klein-mens-lightweight-packable-hooded-puffer-vest',1),

(14,'Columbia Women`s Flash Forward Windbreaker',89.97,162,'"Water resistant fabric 
Draw cord adjustable hood 
Zippered hand pockets 
Elastic cuffs 
Draw cord adjustable hem"',4.1,27,54,'14-1.jpg,14-2.jpg,14-3.jpg','14.mp4','Columbia-Women`s-Flash-Forward-Windbreaker',1),

(15,'Legendary Whitetails Men`s Buck Camp Flannel',36.46,72,'"100% Cotton 
Imported 
...
[Corduroy Lined Cuffs & Collar]: Experience the classic touch of quintessential corduroy lining in our flannel shirt for men; not only does it enhance durability, but it also ensures the collar and cuffs maintain their shape"',3.9,12,24,'15-1.jpg,15-2.jpg',NULL,'legendary-whitetails-mens-buck-camp-flannel',1),

(16,'Amazon Essentials Men`s Regular-Fit Long-Sleeve Henley Shirt',16.1,79122,'"REGULAR FIT: Comfortable, easy fit through the shoulders, chest, and waist
...
DETAILS: Ribbed neck and sleeve hem trim, raglan sleeve with sturdy overlock stitching, and shirttail hem."',4.4,13187,26374,'16-1.jpg,16-2.jpg,16-3.jpg',NULL,'amazon-essentials-mens-regular-fit-long-sleeve-henley-shirt',2),

(17,'Hanes Men’s X-Temp Short Sleeve Polo Shirt',13.36,147618,'"SO SOFT - Midweight pique fabric feels super-soft up against your skin.
...
TEARAWAY TAG - Simply remove the tearaway tag for itch-free comfort."',4.4,24603,49206,'17-1.jpg,17-2.jpg,17-3.jpg',NULL,'hanes-mens-x-temp-short-sleeve-polo-shirt',2),

(18,'Russell Athletic Men`s Dri-Power Long Sleeve Tees',8.59,84870,'"Lightweight cotton blend provides premium softness wash after wash
...
Tag free for comfort"',4.4,14145,28290,'18-1.jpg,18-2.jpg,18-3.jpg',NULL,'russell-athletic-mens-dri-power-long-sleeve-tees',2),

(19,'Amazon Essentials Men`s Regular-Fit Long-Sleeve T-Shirt',14.2,48264,'"REGULAR FIT: Comfortable, easy fit through the shoulders, chest, and waist
LIGHTWEIGHT T-SHIRT JERSEY: Soft and comfortable knit fabric for a go-to lightweight t-shirt.
...
LENGTH: 29"" from side neck on US size M."',4.2,8044,16088,'19-1.jpg,19-2.jpg,19-3.jpg','19.mp4','Amazon-Essentials-Men`s-Regular-Fit-Long-Sleeve-T-Shirt',2),

(20,'Amazon Essentials Men`s Tech Stretch Tank T-Shirt',13.2,37554,'"RELAXED FIT: Comfortable, relaxed fit through shoulders, chest, and waist
...
DETAILS: Featuring a pull-on crew neckline and a sleeveless racer back design for added mobility during workouts."',4.3,6259,12518,'20-1.jpg,20-2.jpg,20-3.jpg','20.mp4','Amazon-Essentials-Men`s-Tech-Stretch-Tank-T-Shirt',2),
...
UPF 50+ protection
Comfortable and versatile"',4.5,1517,3034,'21-1.jpg,21-2.jpg,21-3.jpg',NULL,'Kanu-Surf-Men`s-UPF-50+-Long-Sleeve-Rashguard-Swim-Shirt',2),


(22,'Clique Men`s Parma Colorblock Polo',17.98,264,'"Colorblocked polo with three button placket
Self collar and coverstitch detailing"',4.4,44,88,'22-1.jpg,22-2.jpg,22-3.jpg','22.mp4','Clique-Men`s-Parma-Colorblock-Polo',2)


,(23,'Gildan Adult Fleece Crewneck Sweatshirt',13.48,5142,'"Classic fit for loose comfort
...
Screen printing, embroidery, heat transfer, patches and DTG"',4.8,857,1714,'23-1.jpg,23-2.jpg,23-3.jpg',NULL,'Gildan-Adult-Fleece-Crewneck-Sweatshirt',2),


(24,'Hanes Men’s Tank Top 2-Pack',12.49,57756,'"Either tagless or with easily removed tearaway tag for comfort
...
Either or with easily removed tearaway tag for comfort"',4.5,9626,19252,'24-1.jpg,24-2.jpg,24-3.jpg',NULL,'Hanes-Men’s-Tank-Top-2-Pack',2),


(25,'Amazon Essentials Men`s Slim-Fit Tank Top',10.4,38142,'"SLIM FIT: Slim fit fit through chest, and waist.
...
DETAILS: Jesey binding at armholes and neck for a clean look. Tagless printed label at back neck for extra comfort. Straight hem."',4.4,6357,12714,'25-1.jpg,25-2.jpg,25-3.jpg','25.mp4','Amazon-Essentials-Men`s-Slim-Fit-Tank-Top',2),


(26,'Wrangler Authentics Men`s Long Sleeve Heavyweight Fleece Shirt',27.96,238578,'"BUILT FOR COMFORT: Made with comfort and function in mind, this two-sided brushed fleece will keep you warm all season long. Your new wardrobe favorite.
...
ADDED STORAGE: Constructed with (2) button front pockets, this fleece shirt has easy-access storage for all your basic necessities."',4.6,39763,79526,'26-1.jpg,26-2.jpg,26-3.jpg','26.mp4','Wrangler-Authentics-Men`s-Long-Sleeve-Heavyweight-Fleece-Shirt',2),


(27,'Amazon Essentials Men`s V-Neck Sweater (Available in Big & Tall)',25.6,150990,'"REGULAR FIT: Comfortable, easy fit through the shoulders, chest, and waist
...
OFFICIAL LICENSED PRODUCT: Amazon Essentials offers one-of-a-kind products featuring your favorite characters to add wonder to your wardrobe! All products are officially licensed and designed in-house."',4.5,25165,50330,'27-1.jpg,27-2.jpg,27-3.jpg','27.mp4','amazon-essentials-mens-v-neck-sweater-available-in-big-tall',2),


(28,'Hanes Mens Originals Tri-Blend Tank Top',9.69,2634,'"BASICS THAT ARE FAR FROM BASIC - A stylish collection of cool, modern essentials designed for comfort, made for every body. Be yourself in Hanes Originals.
...
COLD WATER WASH - Hanes recommends machine washing in cold water to reduce energy consumption."',4.3,439,878,'28-1.jpg,28-2.jpg,28-3.jpg',NULL,'hanes-mens-originals-tri-blend-tank-top',2),
...
DURABLE QUALITY: Triple needle stitching dual layer shirt"',4.5,14,28,'29-1.jpg,29-2.jpg,29-3.jpg',NULL, 'legendary-whitetails-mens-tough-as-buck-double-layer-thermal-henley-shirt-casual-long-sleeve-waffle-knit-regular-fit',2),
...
EASY CARE - Machine wash this long-sleeve men`s t-shirt on cold with like colors to reduce energy."',4.6,18222,36444,'30-1.jpg,30-2.jpg,30-3.jpg','30.mp4','champion-classic-and-comfortable-tee',2),
...
TAG-FREE AND ITCH-FREE - Tagless design means no annoying tag to itch or bunch up."',4.4,52525,105050,'32-1.jpg,32-2.jpg,32-3.jpg',NULL,'hanes-comfortsoft-ecosmart-mens-fleece-sweatpants',3),
...
HOME GROWN – Cotton used in this product is sustainably grown on U.S. farms."',4.3,26529,53058,'33-1.jpg,33-2.jpg,33-3.jpg',NULL,'hanes-essentials-sweatpants',3),


(34,'Fruit of the Loom mens Yarn-dye Woven Flannel Pajama Pant',19.99,32574,'"Two deep side seam pockets
Button-thru fly
Elastic waistband and a twill draw cord for a personalized fit"',4.2,5429,10858,'34-1.jpg,34-2.jpg,34-3.jpg',NULL,'fruit-of-the-loom-mens-yarn-dye-woven-flannel-pajama-pant',3),


(35,'Gildan Adult Fleece Open Bottom Sweatpants with Pockets',11.43,158148,'"Classic fit with seamless sides for easier printability
Brushed interior provides superior cozy softness
Jersey-lined pockets
Differential rise for better fit
Slightly tapered leg with open bottom
Tear away label for customizable comfort"',4.3,26358,52716,'35-1.jpg,35-2.jpg,35-3.jpg',NULL,'gildan-adult-fleece-open-bottom-sweatpants-with-pockets',3),
...
(37,'Fruit of the Loom Eversoft Fleece Elastic Bottom Sweatpants with Pockets',13.99,288396,'"Male Model is 6’0” wearing a Size Medium. Female Model is 5’9” wearing size Small.
...
Relaxed banded bottom with Deep Pockets to keep Items secure"',4.4,48066,96132,'37-1.jpg,37-2.jpg,37-3.jpg',NULL,'fruit-of-the-loom-eversoft-fleece-elastic-bottom-sweatpants-with-pockets',3),


(38,'Russell Athletic Dri-Power Fleece Sweatpants & Joggers',13.49,225450,'"Medium-weight 9 oz fleece keeps in body heat so you can stay warm
...
No pockets for a clean sleek look"',4.3,37575,75150,'38-1.jpg,38-2.jpg,38-3.jpg',NULL, 'russell-athletic-dri-power-fleece-sweatpants-and-joggers',3),


(39,'Amazon Essentials Men`s Straight-Fit Woven Pajama Pant',19.9,147186,'"REGULAR FIT: Comfortable, easy fit through the hip and thigh with a straight leg. Sits below the waist.
...
DETAILS: Featuring an elasticated waistband with an adjustable drawcord for ease and comfort, button fly closure, and side pockets to hold your small essentials."',4.4,24531,49062,'39-1.jpg,39-2.jpg,39-3.jpg',NULL,'amazon-essentials-mens-straight-fit-woven-pajama-pant',3),


(40,'Champion mens Pants',24.95,235572,'"THE FIT - Standard-fit men`s pants with a 32.5"" inseam.
...
POCKETS - Two deep side pockets hold lightweight tech."',4.3,39262,78524,'40-1.jpg,40-2.jpg,40-3.jpg',NULL,'champion-mens-pants',3),
...
INSEAM: 30 1/2"" on US size S."',4.2,5764,11528,'42-1.jpg,42-2.jpg,42-3.jpg',NULL,'amazon-essentials-women-s-flannel-sleep-pant',3),


(43,'Champion Women`s Sports Bra',24.95,106008,'"THE FIT – Standard-fit men`s open-bottom sweatpants with an elastic waistband, adjustable drawcord, and 32"" inseam.
...
THE POWERBLEND COLLECTION – A powerhouse fabric blend that’s made for the daily with a stay-true fit and comfort that never quits."',4.5,17668,35336,'43-1.jpg,43-2.jpg,43-3.jpg',NULL,'champion-women-s-sports-bra',3),


(44,'Champion Sweatpants',21.18,3972,'"MID RISE. Show the world a thing or two about being the fashionable legend you already know you are with these mid rise flares. Hitting comfortably at the waist that gives way to a flare leg, these jeans are flattering and on-trend.
...
SPECIFICATIONS. 5 pockets. Zipper fly with button closure. Inseam: 31"" short, 33"" medium, 35"" long. Rise: 9.5"". Bottom Leg Opening: 23"". Destruction details may vary by colorway."',4.1,662,1324,'44-1.jpg,44-2.jpg,44-3.jpg',NULL,'champion-sweatpants',3),


(45,'CHAMPRO Boys Open-Bottom Loose-Fit Baseball Pant with Adjustable Inseam and Reinforced Sliding Area',20.46,10692,'"COMFORTABLE: These loose-fit, straight-leg pants have open bottoms to circulate air and provide a free, relaxed, and comfortable feel
...
DURABLE: A sliding seat and knees reinforced with double-ply fabric create a more durable pant that withstands sliding action and lasts longer through the season"',4.5,1782,3564,'45-1.jpg,45-2.jpg,45-3.jpg',NULL,'champro-boys-open-bottom-loose-fit-baseball-pant-with-adjustable-inseam-and-reinforced-sliding-area',3),


(46,'Lucky Brand Womens Pearl Delicate Necklace',22.8,3840,'Double-layered necklace featuring faux-pearl halo pedant and Y-shaped strand with faceted-bead finish',4.2,640,1280,'46-1.jpg,46-2.jpg,46-3.jpg','46.mp4','lucky-brand-womens-pearl-delicate-necklace',4),


(47,'Lucky Brand Silver-Tone Statement Link Bracelet',25.29,5454,'"Lucky Brand Silver Link Bracelet
Set in silver-tone mixed metal
Approx. length: 7-1/4"" + 1/2"" extender"',4.5,909,1818,'47-1.jpg,47-2.jpg,47-3.jpg','47.mp4','lucky-brand-silver-tone-statement-link-bracelet',4),
...
PERFECT FOR GIFTING : Wonderful gift for all year-round especially as Birthday Gifts, Bridesmaid`s Gifts, Anniversary Gifts, Mother`s Day Gifts, Wedding Gifts, Christmas Gifts or any other holiday gifts. Perfect statement piece for any ensemble!HYPOALLERGENIC JEWELRY: Made with nickel and lead free metal that is less likely to cause any allergic reaction"',4.4,5032,10064,'48-1.jpg,48-2.jpg','48.mp4','betsey-johnson-womens-butterfly-charms-layered-necklace',4),


(49,'Amazon Essentials 14k Yellow Gold 8mm ',125.7,48,'"This product was previously sold as Amazon Collection and now as Amazon Essentials.
...
CARE: Gemstone pendant necklace with anti-tarnish coating should be stored in a cool, dry place in its own box; limit exposure to extreme temperatures, perfume, and household cleaning products"',3.6,8,16,'49-1.jpg,49-2.jpg,49-3.jpg','49.mp4','amazon-essentials-14k-yellow-gold-8mm',4),
...
Items delivered: (1) Swarovski Millenia pendant necklace with pink, octagon-cut Swarovski crystal and white crystal frame on a rose gold-tone finish chain, complete with Swarovski necklace box"',4.6,88,176,'50-1.jpg,50-2.jpg,50-3.jpg','50.mp4','swarovski-millenia-crystal-pendant-necklace-collection',4),


(51,'Carhartt Casual Rugged Canvas Duck Belts for Men',29.99,1626,'"CANVAS DUCK BELT: Rugged and Reliable accessory crafted for those who appreciate both form and function. Made from a substantial 12-ounce firm-hand 100% ringspun cotton duck with a corduroy backing, this belt is a true testament to durability and quality.
...
WIDTH: 1 1/2"""',4.5,271,542,'51-1.jpg,51-2.jpg,51-3.jpg',NULL,'carhartt-casual-rugged-canvas-duck-belts-for-men',4),


(52,'Dickies Men`s 1 1/2 inch Solid Straight Clip Adjustable X Back Suspender',22.59,252444,'"PERFECT STYLE: High quality, heavy duty X-back shape design. Enjoy a great fit with our four metal clips that attach to any kind of pants, jeans or trousers. These clasps will grip on securely without unintentional unbuckling.
...
HOW TO USE: Just quickly and easily release the two side clips when needed. Ideal for work, occasions, or to dress up a casual look. This accessory works best with dress pants, trousers, or jeans."',4.5,42074,84148,'52-1.jpg,52-2.jpg,52-3.jpg',NULL,'dickies-men-s-1-1-2-inch-solid-straight-clip-adjustable-x-back-suspender',4),


(53,'Dickies Men`s No-Scratch Leather Mechanic Belt',19.99,77088,'"UNIQUE: At first you may think ""how does this belt work?"" Well, bear with us for a minute. This no-metal visible belt is a must-have if you are looking to hold your pants subtly. Its unique design makes the extra length of the belt sits on the inside.
...
SIZING: For best fit, select a belt size 2 inches larger than your pant size. For example, if your pant size is 34, shop belt size Medium (36-38). Strap is 1.4 inches wide for a standard fit that will fit all of the belt loops in your closet."',4.5,12848,25696,'53-1.jpg,53-2.jpg,53-3.jpg',NULL,'dickies-men-s-no-scratch-leather-mechanic-belt',4),


(54,'Under Armour Men`s Performance Headband',5.99,91800,'"Headband/sweatband constructed in multi-channel performance fibers
...
(55,'Puma Golf Men`s Reversible Web Belt (One Size)',14.9,24408,'"Metal Clamp Buckle
Reversible Web Strap
Bottle Opener On Back Of Buckle
Country Of Origin: China"',4.6,4068,8136,'55-1.jpg,55-2.jpg,55-3.jpg','55.mp4','puma-golf-men-s-reversible-web-belt-one-size',4),


(56,'Carhartt Men`s Rugged Leather Triple Stitch Wallet',39.99,13002,'"Carhartt Men`s Leather Triple-Stitched Trifold Wallet. Men`s leather wallet with a protective patch
...
Dimensions: 4.5"" x 3.5"" x 0.75"""',4.7,2167,4334,'56-1.jpg,56-2.jpg,56-3.jpg','56.mp4','carhartt-men-s-rugged-leather-triple-stitch-wallet',4),

(57,'Under Armour Men`s 3-inch Performance Wristband 2-Pack',6.99,41748,'"Headband/sweatband constructed in multi-channel performance fibers
Material wicks sweat & dries really fast
Embroidered UA logo
Sold in pairs
Width: 3"""',4.7,6958,13916,'57-1.jpg,57-2.jpg,57-3.jpg',NULL,'under-armour-men-s-3-inch-performance-wristband-2-pack',4),


(58,'Carhartt Men`s Flip It',25.99,19140,'"Mossy Oak camo fleece shell; synthetic palm; flip mitt construction
...
(60,'Amscan Striking Skull Bandana - Black & White',4.62,2742,'"BOLD PIRATE DESIGN: Stand out with the Striking Skull Bandana, featuring a pirate`s skull and crossbones printed design on a black background, perfect for adding some edge to your next event or costume.
...
VERSATILE COSTUME ACCESSORY: Ideal for role-playing games, Halloween events, and pirate-themed costumes, this Striking Skull Bandana will add an authentic touch to your ensemble.BOOST YOUR LOOK WITH CONFIDENCE: Make a powerful statement with this black and white skull bandana that combines fashion, function, and versatility for an unforgettable look."',3.9,457,914,'60-1.jpg,60-2.jpg',NULL,'amscan-striking-skull-bandana-black-&-white',4),
...
The Flexfit Mission: Born from a vision to redefine the ordinary, we`re committed to constant evolution; Leveraging 40 years of manufacturing expertise, we aim to produce the highest quality caps in styles, colors, and sizes for all"',4.5,18612,37224,'61-1.jpg,61-2.jpg,61-3.jpg','61.mp4','flexfit-unisex-adult-cotton-twill-fitted-cap-hat',5),
...
GREAT TO SHARE (GREAT GIFT IDEA TOO!) – while you are enjoy it, send it to your family, friends, or people you loved as a gift for Christmas, New Years, Valentine`s Day, Father`s day, Mother`s Day etc! Also,it`s a great gift to runners, athletes, fitness workouts, hiking, cycling, or anyone who need it"',4.5,25478,50956,'62-1.jpg,62-2.jpg,62-3.jpg','62.mp4','achiou-ski-mask-for-men-women',5),


(63,'MEANBEAUTY 27 Square Silk Like Head Scarf for Women',9.49,3846,'"【MATERIAL】: This Neck Scarf made of premium satin fabric, silk feeling, soft, comfortable, breathable, skin-friendly, cozy, fashionable and stylish. Meanwhile, an array of colors and patterns allow you to match easily with daily outfits.
...
HOW TO MAINTAIN: The winter set is easy to clean and maintain.Hand wash gently in cold water below 30 degree with a neutral detergent or dry cleaning. Do not scrub or wring hard."',4.5,641,1282,'63-1.jpg,63-2.jpg,63-3.jpg',null,'meanbeauty-27"-square-silk-like-head-scarf-for-women',5),
...
WHY CUSTOMERS LOVE KBETHOS:✔️As one of the top headwear choice for Amazon, KBETHOS is a headwear brand you can TRUST.✔️With hundreds of styles & looks, it is a great & fun experience.✔️Moreover, our customer support is unmatchable and unbeatable.✔️Contact us for anything!✔️Warm your heads today!✔️"',4.6,16408,32816,'64-1.jpg,64-2.jpg,64-3.jpg',NULL,'reef-womens-kbethos-vintage-washed-distressed-cotton',5),

(65,'TopHeadwear 3-Hole Ski Face Mask Balaclava',20,21138,'"Availabel in a variety of colors
3-Hole Style Ski Mask
One Size Fits Most"',4.2,3523,7046,'65-1.jpg,65-2.jpg,65-3.jpg',null,'kbethos-vintage-washed-distressed-cotton',5),
...
Available in various colors to choose from"',4.6,4320,8640,'66-1.jpg,66-2.jpg,66-3.jpg',null,'classic-plain-ponytail-messy-high-bun-headwear-adjustable-cotton',5),
...
This colorway comes with 2 shields, the clear (on the helmet) and dark smoke is included in the box.DOT approved. Meets the FMVSS 218 Standard"',4.5,1442,2884,'67-1.jpg,67-2.jpg,67-3.jpg',null,'bell-qualifier-dlx-full-face-blackout-helmet',5),


(68,'Volcom Men`s Full Stone Flexfit Hat',29.95,18402,'"Six-panel flex-fit baseball cap featuring logo embroidery at front crown
...
Signature-soft blend of lightweight and breathable fabric is designed for all-day comfort"',4.7,3067,6134,'68-1.jpg,68-2.jpg,68-3.jpg',null,'volcom-men`s-full-stone-flexfit-hat',5),


(69,'Callaway Golf Relaxed Retro Collection Headwear',31.99,372,'"Low Profile
Retro Patch Design
Cooling Sweatband"',4.6,62,124,'69-1.jpg,69-2.jpg,69-3.jpg',null,'callaway-golf-relaxed-retro-collection-headwear',5),
...
Activity: casual
Manufacturer : 1 year
Age range descriptionAdult"',4.8,794,1588,'70-1.jpg,70-2.jpg,70-3.jpg',null,'coal-uniform-acyrlic-workwear-knit-cuff-beanie',5),


(71,'Pacific Headwear Waxed Cotton Dad Cap',16.99,42,'"Waxed cotton
Low profile
Curved visor
Matching eyelets; Pro-stitched finish
Self-fabric strap with brass buckle clasp"',4.6,7,14,'71-1.jpg,71-2.jpg,71-3.jpg',null,'pacific-headwear-waxed-cotton-dad-cap',5),
...
Special Size-Standard"',4.6,1648,3296,'73-1.jpg,73-2.jpg,73-3.jpg',null,'timberland-men`s-cotton-canvas-baseball-cap',5),


(74,'Timberland Women`s Classic Tall Beanie',22.8,1398,'"COLD WEATHER HAT: Timberland Women`s Classic Tall Beanie, featuring logo on cuff.
...
COZY GIFT: An ideal gift for family, loved ones and friends for Christmas, Birthdays, Valentine`s Day, New Year’s Days, Wedding Anniversary, Thanksgiving, Holidays and more"',4.6,233,466,'74-1.jpg,74-2.jpg,74-3.jpg',null,'timberland-women`s-classic-tall-beanie',5),


(75,'Concept One U.s Polo Assn',19.99,1050,'"BASEBALL HAT: Officially licensed U.S Polo Association adjustable golf cap with an embroidered horse logo on the frontONE SIZE FITS ALL: Features an adjustable silver metal buckle closure embossed with an American flag to allow for easy resizing for a comfortable fit on heads of all shapes and sizes
CURVED BRIM: Features a curved brim with stitching to keep the Sun`s UV rays out of your eyes
100% COTTON: Lightweight and durable cotton fabric allows for instant comfort when worn HAND WASH ONLY: Recommended for hand washing only, lay flat to dry, do not iron"',4.5,175,350,'75-1.jpg,75-2.jpg,75-3.jpg',null,'concept-one-u.s-polo-assn',5),


(76,'Under Armour Men`s Ignite Pro Slide',29.67,270,'"Adjustable synthetic strap with soft foam lining for added comfort & perforations for breathability
...
Water Resistance Level: not_water_resistant"',4.2,45,90,'76-1.jpg,76-2.jpg,76-3.jpg',null,'under-armour-men`s-ignite-pro-slide',6),


(77,'YOKI Women`s Heels Platform',39.99,168,'"Open Round Toe
Padded Inner Footbed
4"" Chunky Heel
Adjustable Upper Ankle Buckle Strap"',3.7,28,56,'77-1.jpg,77-2.jpg,77-3.jpg',null,'yoki-women`s-heels-platform',6),


(78,'Skechers Men`s Nampa Food Service Shoe',39.99,74124,'"Memory Foam Footbed
Relaxed Fit
Slip Resistant
Electrical Hazard
Food Service
...
(79,'Blowfish Malibu Unisex-Child Fashion Sneaker',33.22,18918,'"Velcro enclosure
Fabric linings
Manmade outsole
Canvas fabric upper with metal grommet accents"',4.6,3153,6306,'79-1.jpg,79-2.jpg,79-3.jpg',null,'blowfish-malibu-unisex-child-fashion sneaker',6),


(80,'Columbia Men`s Bonehead PFG Boat Shoe
',73.68,3006,'"Omni-Grip non-marking wet grip outsole with razor siping
...
Combination open mesh and synthetic upper; Soft heel material for added comfort; Blood `n Guts water and stain resistant treatment"',4.5,501,1002,'80-1.jpg,80-2.jpg,80-3.jpg',null,'columbia-men`s-bonehead-pfg-boat-shoe',6),


(81,'Chooka Women`s Waterproof Plush Chelsea Bootie Chelsea Boot',41.99,39516,'"durable waterproof boots, fashion meets function with these ankle high booties. 100% waterproof with a fashionable matte finish
...
cleaning, use a damp cloth with water and soap to clean your boots"',4.3,6586,13172,'81-1.jpg,81-2.jpg,81-3.jpg','81.mp4', 'chooka-womens-waterproof-plush-chelsea-bootie-chelsea-boot',6),


(82,'DUNLOP Protective Footwear MD0HD01.13 Dane',28.95,3348,'"LIGHTWEIGHT: The Dane boots are made to be lightweight, up to 25% lighter than classic PVC boots.
...
DUNLOP PROTECTIVE FOOTWEAR: We are Dunlop Protective Footwear, the world’s leading manufacturer of protective footwear. In more than 75 countries worldwide, we provide comfortable and protective footwear for workers across multiple industries."',4.4,558,1116,'82-1.jpg,82-2.jpg,82-3.jpg',NULL,'dunlop-protective-footwear-md0hd01-13-dane',6),


(83,'GUESS Women`s Avin Wedge Sandal',59.95,11970,'"Logo graphic straps elevated on a chunky platform heel lend warm-weather lift to casual style in the Avin sandals from GUESS.
Hook and Loop closure
Open Toe
Guess detailing on straps"',4.6,1995,3990,'83-1.jpg,83-2.jpg,83-3.jpg',NULL,'guess-women`s-avin-wedge-sandal',6),


(84,'Crocs Unisex-Adult Classic Clogs',49.99,3410562,'"Crocs For Women And Men: The Crocs Classic Clogs Are Not Only The Most Comfortable Shoes For Women And Men But Also Easy To Clean Just Using Soap And Water And Allowing For A Quick Dry.
...
(86,'Reef Women`s Bliss Nights Flip-Flop',23.39,67182,'"VEGAN LEATHER + RUBBER SOLE: The freshness of vegan leather paired with the comfort of the flexible sponge outsole keeps you on trend and your feet happy. The stylish design and versatility means you can seamlessly go from brunch to a walk on the beach.
...
BEACH FREELY: REEF encourages people around the world to embrace the spirit of the beach while living by one simple rule: Beach Freely. Our products are designed to make you feel comfortable in any environment, whether you`re at the beach or not."',4.3,11197,22394,'86-1.jpg,86-2.jpg,86-3.jpg',NULL,'reef-womens-bliss-nights-flip-flop',6),


(87,'Bloch womens Eclipse Canvas Contemporary Ballet Shoe S0619l',44.51,8850,'"Soft canvas upper
...
Leather front outsole with traditional ballet shoe pleating for turning eas"',4.6,1475,2950,'87-1.jpg,87-2.jpg,87-3.jpg',NULL,'bloch-womens-eclipse-canvas-contemporary-ballet-shoe-s0619l',6),
...
STYLISH and VERSATILE : The Jason Samuels Smith Dance Shoe for Women has a sleek and elegant design that is popular among serious dancers. The shoe is available in various colors and styles, making it easy for dancers to find one that suits their style and preferences."',4.7,871,1742,'88-1.jpg,88-2.jpg,88-3.jpg',NULL,'reef-womens-bloch-womens-jason-samuels-smith-ballet-flat',6),


(89,'Capezio Women`s Cadence Oxford',84.4,1170,'"Women: Begin with street shoe size - 1/2 size up. Men: Begin 2 sizes up from street shoe size.
...
Tapered heel, Scored rubber sole patch for traction"',4.5,195,390,'89-1.jpg,89-2.jpg,89-3.jpg',NULL,'bloch-womens-jason-samuels-smith-ballet-flat',6),


(90,'Capezio Girl`s Jr. Tyette Tap Shoe Dance',57.44,79866,'"PVC (black patent) and PU leather (caramel and white) uppers
