...
INSERT INTO Account (username, email, hashed_password, is_admin) VALUES ('site_user', 'abc@gmail.com', '$2a$12$qTSuT5h7Y3tsXQ/YO63iEecCyKmu.Bgg0K6Lr.lktxdAwxc8MhJE6', 0);
...
values
    (1,'Hanes mens Ecosmart Hoodie',16,1083012,'"FLEECE TO FEEL GOOD ABOUT - Hanes EcoSmart men-s hoodie is made with cotton sourced from American farms.
...
SPECIFICATIONS. 5 pockets. Zipper fly with button closure. Inseam: 31"" short, 33"" medium, 35"" long. Rise: 9.5"". Bottom Leg Opening: 23"". Destruction details may vary by colorway."',4.1,662,1324,'44-1.jpg,44-2.jpg,44-3.jpg',NULL,'champion-sweatpants',3),
    ...
    (45,'CHAMPRO Boys Open-Bottom Loose-Fit Baseball Pant with Adjustable Inseam and Reinforced Sliding Area',20,10692,'"COMFORTABLE: These loose-fit, straight-leg pants have open bottoms to circulate air and provide a free, relaxed, and comfortable feel
...
DURABLE: A sliding seat and knees reinforced with double-ply fabric create a more durable pant that withstands sliding action and lasts longer through the season"',4.5,1782,3564,'45-1.jpg,45-2.jpg,45-3.jpg',NULL,'champro-boys-open-bottom-loose-fit-baseball-pant-with-adjustable-inseam-and-reinforced-sliding-area',3),
    ...
    (46,'Lucky Brand Womens Pearl Delicate Necklace',22,3840,'Double-layered necklace featuring faux-pearl halo pedant and Y-shaped strand with faceted-bead finish',4.2,640,1280,'46-1.jpg,46-2.jpg,46-3.jpg','46.mp4','lucky-brand-womens-pearl-delicate-necklace',4),
