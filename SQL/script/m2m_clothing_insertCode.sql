...
values(1,'Hanes mens Ecosmart Hoodie, Midweight Fleece Sweatshirt, Pullover Hooded Sweatshirt for Men',16.26,1083012,'"FLEECE TO FEEL GOOD ABOUT - Hanes EcoSmart men`s hoodie is made with cotton sourced from American farms. 
...
MADE TO LAST - Double-needle stitching at the neck and armholes for added sturdiness."',4.5,180502,361004,'1-1.jpg,1-2.jpg,1-3.jpg','1.mp4',1),(2,'Fruit of the Loom Eversoft Fleece Hoodies, Pullover & Full Zip, Moisture Wicking & Breathable, Sizes S-4X',35.76,353118,'"Male Model is 6’0” wearing a Size Medium. 
...
Ribbed cuffs and waistband that hold their shape Shoulder-to-shoulder neck tape for comfort and durability"',4.6,58853,117706,'2-1.jpg,2-2.jpg,2-3.jpg','2.mp4',1),(3,'Gildan Fleece Hoodie Sweatshirt, Style G18500, Multipack',18.42,724074,'preshrunk 50% cotton/50% dryblend polyester moisture-wicking fabric air-jet yarn for softer feel and no pilling double-lined hood with matching drawstring double-needle stitching',4.7,120679,241358,'3-1.jpg,3-2.jpg,3-3.jpg','3.mp4',1),(4,'Columbia Men`s Glennaker Rain Jacket',65,1278,'"WATERPROOF TECHNOLOGY: You’ll love our Columbia Men`s Glennaker Lake Rain Jacket, it features our Hydroplus waterproof nylon fabric for the ultimate in lightweight, wet weather, protection and comfort. 
...
SPOT THE C - This raincoat features the iconic C logo at the wrist. Note: C logo patch color may vary from image."',4.6,5874,11748,'5-1.jpg,5-2.jpg,5-3.jpg','5.mp4',1),(6,'Columbia Men`s Flashback Windbreaker',50.29,6384,'"COMFORTABLE WINDBREAKER: The Columbia Men’s Flashback Windbreaker is a water resistant shell, designed to shield you and keep you warm on cool blustery days. 
...
BUILT TO LAST: Columbia’s attention to detail is what sets our apparel apart. Specifying only the highest quality materials, expert stitching and craftsmanship. This is a long-lasting jacket you will enjoy for seasons to come."',4.4,1064,2128,'6-1.jpg,6-2.jpg,6-3.jpg',NULL,1),(7,'Charles River Apparel Pack-n-go Windbreaker Pullover Hooded Jacket',37,11316,'"Packable Style- Our lightweight windbreaker folds into its own front pouch pocket with zipper closure for easy packing on the go. An essential for backpacking, exercise, or casual use 
...
For 40 years and three generations, we have been guided by our roots. Inspired by the change of seasons, and the abundance of natural beauty around us, Charles River Apparel creates timeless styles that weather the elements as well as the trends"',4.6,1886,3772,'7-1.jpg,7-2.jpg,7-3.jpg','7.mp4',1),(8,'Tommy Hilfiger Women`s Casual Band Jacket, Fall Fashion',109.5,2328,'"Classic Tommy Hilfiger style: If you’re into blazer jackets for women perfect for fall no need to look further; with brass-style buttons and band style fashion detailing, this jacket is a fashion statement must-have for any wardrobe 
...
Fall into Winter: Add a sweater under your jacket when it gets cold; on your feet, wear booties for women with pants, knee high boots with skinnies or a classic pair of high heeled pumps to complete the look for day or night"',4.4,388,776,'8-1.jpg,8-2.jpg,8-3.jpg',NULL,1),(9,'Calvin Klein Women`s One Button Lux Blazer',71.74,1320,'"Universal match: Dress up or down no matter the season, great for spring, summer, fall and winter; easily transition from day to night by pairing with a blouse, shirt, jacket, cardigan, heels or sandals 
Year-round luxury: Wear a coat over these women’s blazer in the winter, cardigan in the spring and summer or wear them to relax around the home"',4.5,220,440,'9-1.jpg,9-2.jpg',NULL,1),(10,'Calvin Klein Women`s Two Button Lux Blazer (Petite, Standard, & Plus)',99,8736,'"Lapel collar 
Flap pockets"',4.3,1456,2912,'10-1.jpg,10-2.jpg,10-3.jpg',NULL,1),(11,'Men`s Duck Work Vest',46.03,240,'"Durable work duck vest with 100% duck cotton shell for lasting performance and 100% polyester lining for added comfort 
...
Rugged metal zipper and zipper pull for a durable and stylish look"',4.7,40,80,'11-1.jpg,11-2.jpg,11-3.jpg',NULL,1),(12,'Columbia Men`s Steens Mountain Vest',39.99,342,'"DEEP PILE FLEECE: The Columbia Collegiate Men`s Flanker Vest II is crafted of deep and cozy 250g MTR filament fleece for ultimate warmth and college flair 
...
BUILT TO LAST: Columbia’s attention to detail is what sets our apparel apart. Specifying only the highest quality materials, expert stitching and craftsmanship. This is a long-lasting vest you will enjoy for seasons to come"',4.2,57,114,'12-1.jpg,12-2.jpg,12-3.jpg',NULL,1),(13,'Calvin Klein Men`s Lightweight Packable Hooded Puffer Vest',49.99,3654,'"Quality performance: Vest for men with front center zipper that extends into the hood with an adjustable bungee system to maintain warmth; keep your valuables safe with 2 side zipper pockets 
...
Comfort and style: This men’s vest is sure to become a staple in your closet; bring it along in your work bag, wear it for a night out, on vacation or as part of your daily outfit"',4.6,609,1218,'13-1.jpg,13-2.jpg,13-3.jpg',NULL,1),(14,'Columbia Women`s Flash Forward Windbreaker',89.97,162,'"Water resistant fabric 
Draw cord adjustable hood 
Zippered hand pockets 
Elastic cuffs 
Draw cord adjustable hem"',4.1,27,54,'14-1.jpg,14-2.jpg,14-3.jpg','14.mp4',1),(15,'Legendary Whitetails Men`s Buck Camp Flannel, Long Sleeve Plaid Button Down Casual Shirt, Corduroy Cuffs',36.46,72,'"100% Cotton 
Imported 
...
[Corduroy Lined Cuffs & Collar]: Experience the classic touch of quintessential corduroy lining in our flannel shirt for men; not only does it enhance durability, but it also ensures the collar and cuffs maintain their shape"',3.9,12,24,'15-1.jpg,15-2.jpg',NULL,1),(16,'"Amazon Essentials Men`s
...
TEARAWAY TAG - Simply remove the tearaway tag for itch-free comfort."',4.4,24603,49206,'17-1.jpg,17-2.jpg,17-3.jpg',NULL,2),(18,'"Russell Athletic Men`s 
...
Tag free for comfort"',4.4,14145,28290,'18-1.jpg,18-2.jpg,18-3.jpg',NULL,2),(19,'"Amazon Essentials Men`s 
Regular-Fit Long-Sleeve 
...
LENGTH: 29"" from side neck on US size M."',4.2,8044,16088,'19-1.jpg,19-2.jpg,19-3.jpg','19.mp4',2),(20,'"Amazon Essentials Men`s 
...
DETAILS: Featuring a pull-on crew neckline and a sleeveless racer back design for added mobility during workouts."',4.3,6259,12518,'20-1.jpg,20-2.jpg,20-3.jpg','20.mp4',2),(21,'"Kanu Surf Men`s UPF 50+ 
Long Sleeve Rashguard 
Swim Shirt"',18.58,9102,'"Loose-fit rashguard in solid tone featuring long sleeves and crew neckline
UPF 50+ protection
Comfortable and versatile"',4.5,1517,3034,'21-1.jpg,21-2.jpg,21-3.jpg',NULL,2),(22,'"Clique Men`s Parma 
Colorblock Polo"',17.98,264,'"Colorblocked polo with three button placket
Self collar and coverstitch detailing"',4.4,44,88,'22-1.jpg,22-2.jpg,22-3.jpg','22.mp4',2),(23,'"Gildan Adult Fleece 
...
Screen printing, embroidery, heat transfer, patches and DTG"',4.8,857,1714,'23-1.jpg,23-2.jpg,23-3.jpg',NULL,2),(24,'"Hanes Men’s Tank Top 
...
Either or with easily removed tearaway tag for comfort"',4.5,9626,19252,'24-1.jpg,24-2.jpg,24-3.jpg',NULL,2),(25,'"Amazon Essentials Men`s 
...
DETAILS: Jesey binding at armholes and neck for a clean look. Tagless printed label at back neck for extra comfort. Straight hem."',4.4,6357,12714,'25-1.jpg,25-2.jpg,25-3.jpg','25.mp4',2),(26,'"Wrangler Authentics Men`s 
...
ADDED STORAGE: Constructed with (2) button front pockets, this fleece shirt has easy-access storage for all your basic necessities."',4.6,39763,79526,'26-1.jpg,26-2.jpg,26-3.jpg','26.mp4',2),(27,'"Amazon Essentials Men`s 
...
OFFICIAL LICENSED PRODUCT: Amazon Essentials offers one-of-a-kind products featuring your favorite characters to add wonder to your wardrobe! All products are officially licensed and designed in-house."',4.5,25165,50330,'27-1.jpg,27-2.jpg,27-3.jpg','27.mp4',2),(28,'"Hanes Mens Originals 
...
DURABLE QUALITY: Triple needle stitching dual layer shirt"',4.5,14,28,'29-1.jpg,29-2.jpg,29-3.jpg',NULL,2),(30,'Champion, Classic and Comfortable Tee, Long-Sleeve T-Shirt for Men (Reg. Or Big & Tall)',25,109332,'"THE FIT - Standard fit long-sleeve t-shirt for men.
...
HYPOALLERGENIC JEWELRY: Made with nickel and lead free metal that is less likely to cause any allergic reaction"',4.4,5032,10064,'48-1.jpg,48-2.jpg','48.mp4',4),(49,'Amazon Essentials 14k Yellow Gold 8mm Cushion Cut April Birthstone Created White Sapphire Solitaire Pendant Necklace for Women with 18 inch Box Chain (previously Amazon Collection)',125.7,48,'"This product was previously sold as Amazon Collection and now as Amazon Essentials.
...
CARE: Gemstone pendant necklace with anti-tarnish coating should be stored in a cool, dry place in its own box; limit exposure to extreme temperatures, perfume, and household cleaning products"',3.6,8,16,'49-1.jpg,49-2.jpg,49-3.jpg','49.mp4',4),(50,'Swarovski Millenia Crystal Pendant Necklace Collection',94,88,'"Measurements: 14 7/8 inches, Pendant size: 14 7/8 x 3/8 inches
...
Items delivered: (1) Swarovski Millenia pendant necklace with pink, octagon-cut Swarovski crystal and white crystal frame on a rose gold-tone finish chain, complete with Swarovski necklace box"',4.6,88,176,'50-1.jpg,50-2.jpg,50-3.jpg','50.mp4',4),(51,'Carhartt Casual Rugged Canvas Duck Belts for Men',29.99,1626,'"CANVAS DUCK BELT: Rugged and Reliable accessory crafted for those who appreciate both form and function. Made from a substantial 12-ounce firm-hand 100% ringspun cotton duck with a corduroy backing, this belt is a true testament to durability and quality.
DURABLE STICHING: robust construction is evident in its durable stiching. Able to withstand all day wear and tear. This belt was built to be a relaible accessory for any task.
ANTIQUE BRASS BUCKLE: the classic antique brass buckle adds a unique vintage charm while allowing for a customizable fit, ensuring comfort and style.
...
SIZING: For best fit, select a belt size 2 inches larger than your pant size. For example, if your pant size is 34, shop belt size Medium (36-38). Strap is 1.4 inches wide for a standard fit that will fit all of the belt loops in your closet."',4.5,12848,25696,'53-1.jpg,53-2.jpg,53-3.jpg',NULL,4),(54,'Under Armour Men`s Performance Headband',5.99,91800,'"Headband/sweatband constructed in multi-channel performance fibers
Moisture Transport System wicks sweat away from the body
Embroidered UA logo"',4.5,15300,30600,'54-1.jpg,54-2.jpg','54.mp4',4),(55,'Puma Golf Men`s Reversible Web Belt (One Size)',14.9,24408,'"Metal Clamp Buckle
Reversible Web Strap
Bottle Opener On Back Of Buckle
Country Of Origin: China"',4.6,4068,8136,'55-1.jpg,55-2.jpg,55-3.jpg','55.mp4',4),(56,'Carhartt Men`s Rugged Leather Triple Stitch Wallet, Available in Multiple Styles',39.99,13002,'"Carhartt Men`s Leather Triple-Stitched Trifold Wallet. Men`s leather wallet with a protective patch
...
Dimensions: 4.5"" x 3.5"" x 0.75"""',4.7,2167,4334,'56-1.jpg,56-2.jpg,56-3.jpg','56.mp4',4),(57,'Under Armour Men`s 3-inch Performance Wristband 2-Pack',6.99,41748,'"Headband/sweatband constructed in multi-channel performance fibers
Material wicks sweat & dries really fast
Embroidered UA logo
Sold in pairs
Width: 3"""',4.7,6958,13916,'57-1.jpg,57-2.jpg,57-3.jpg',NULL,4),(58,'Carhartt Men`s Flip It',25.99,19140,'"Mossy Oak camo fleece shell; synthetic palm; flip mitt construction
Synthetic reinforced palm and thumb
Magnetic mitt; open fingers and thumbs
Elastic wrist
Lycra binding hem"',4.4,3190,6380,'58-1.jpg,58-2.jpg,58-3.jpg','58.mp4',4),(59,'Under Armour Mens Clean Up Baseball Gloves',30,0,'"87% Nylon, 13% Elastane
Imported
...
Sold in pairs"',4.7,33,66,'59-1.jpg,59-2.jpg',NULL,4),(60,'Amscan Striking Skull Bandana - Black & White Polyester Design - Perfect for Role Playing, Halloween, and Pirate Costumes - 1 Pc.',4.62,2742,'"BOLD PIRATE DESIGN: Stand out with the Striking Skull Bandana, featuring a pirate`s skull and crossbones printed design on a black background, perfect for adding some edge to your next event or costume.
...
VERSATILE COSTUME ACCESSORY: Ideal for role-playing games, Halloween events, and pirate-themed costumes, this Striking Skull Bandana will add an authentic touch to your ensemble.
BOOST YOUR LOOK WITH CONFIDENCE: Make a powerful statement with this black and white skull bandana that combines fashion, function, and versatility for an unforgettable look."',3.9,457,914,'60-1.jpg,60-2.jpg',NULL,4),(61,'Flexfit Unisex Adult Cotton Twill Fitted Cap Hat',11,111672,'"Great-Looking Baseball Hats for Men and Women: These blank 6-panel Flexfit hats feature a mid-profile cotton-twill texture that provides all-day casual comfort with a rounded athletic shape and stretch band to fit all sizes
...
The Flexfit Mission: Born from a vision to redefine the ordinary, we`re committed to constant evolution; Leveraging 40 years of manufacturing expertise, we aim to produce the highest quality caps in styles, colors, and sizes for all"',4.5,18612,37224,'61-1.jpg,61-2.jpg,61-3.jpg','61.mp4',5),(62,'Achiou Ski Mask for Men Women, Balaclava Face Mask, Shiesty Mask UV Protector Lightweight for Motorcycle Snowboard',7,152868,'"ULTIMATE PROTECTION – Achiou balaclava face mask is made of high-quality breathable UPF 50+ mesh fabric, super comfortable, lightweight, and durable. Protect your head and face from UV rays, dust, and wind
...
GREAT TO SHARE (GREAT GIFT IDEA TOO!) – while you are enjoy it, send it to your family, friends, or people you loved as a gift for Christmas, New Years, Valentine`s Day, Father`s day, Mother`s Day etc! Also,it`s a great gift to runners, athletes, fitness workouts, hiking, cycling, or anyone who need it"',4.5,25478,50956,'62-1.jpg,62-2.jpg,62-3.jpg','62.mp4',5),(63,'MEANBEAUTY 27" Square Silk Like Head Scarf for Women Satin Wrapping Scarves Bandanas Headwear and Gift Box Packaging',9.49,3846,'"【MATERIAL】: This Neck Scarf made of premium satin fabric, silk feeling, soft, comfortable, breathable, skin-friendly, cozy, fashionable and stylish. Meanwhile, an array of colors and patterns allow you to match easily with daily outfits.
...
HOW TO MAINTAIN: The winter set is easy to clean and maintain.Hand wash gently in cold water below 30 degree with a neutral detergent or dry cleaning. Do not scrub or wring hard."',4.5,641,1282,'63-1.jpg,63-2.jpg,63-3.jpg',NULL,5),(64,'KBETHOS Vintage Washed Distressed Cotton Dad Hat Baseball Cap Adjustable Polo Trucker Unisex Style Headwear Adjustable',12,98448,'"Vintage Distressed Washed Style Mesh Back
Adjustable Snapback Closure
Great Fit for Most Head Sizes; Dad Hat Low Profile Unconstructed
WHY CUSTOMERS LOVE KBETHOS:✔️As one of the top headwear choice for Amazon, KBETHOS is a headwear brand you can TRUST.✔️With hundreds of styles & looks, it is a great & fun experience.✔️Moreover, our customer support is unmatchable and unbeatable.✔️Contact us for anything!✔️Warm your heads today!✔️"',4.6,16408,32816,'64-1.jpg,64-2.jpg,64-3.jpg',NULL,5),(65,'TopHeadwear 3-Hole Ski Face Mask Balaclava',20,21138,'"Availabel in a variety of colors
3-Hole Style Ski Mask
One Size Fits Most"',4.2,3523,7046,'65-1.jpg,65-2.jpg,65-3.jpg',NULL,5),(66,'Classic Plain Ponytail Messy High Bun Headwear Adjustable Cotton Trucker Mesh Glitter Hat Baseball Cap',15,25920,'"Features ponytail slot that is perfect for pulling your bun or high ponytail through
Adjustable to fit most sizes
Everyday cap for all occasions
Available in various colors to choose from"',4.6,4320,8640,'66-1.jpg,66-2.jpg,66-3.jpg',NULL,5),(67,'Bell Qualifier DLX Full-Face Blackout Helmet',160,8652,'"Communications port no longer built in to helmet. Picture incorrect
...
DOT approved. Meets the FMVSS 218 Standard"',4.5,1442,2884,'67-1.jpg,67-2.jpg,67-3.jpg',NULL,5),(68,'Volcom Men`s Full Stone Flexfit Hat',29.95,18402,'"Six-panel flex-fit baseball cap featuring logo embroidery at front crown
...
Signature-soft blend of lightweight and breathable fabric is designed for all-day comfort"',4.7,3067,6134,'68-1.jpg,68-2.jpg,68-3.jpg',NULL,5),(69,'Callaway Golf Relaxed Retro Collection Headwear',31.99,372,'"Low Profile
Retro Patch Design
Cooling Sweatband"',4.6,62,124,'69-1.jpg,69-2.jpg,69-3.jpg',NULL,5),(70,'Coal Uniform Acyrlic Workwear Knit Cuff Beanie',27,4764,'"Material: 100% acrylic
Style: cuff
Activity: casual
Manufacturer : 1 year
Age range descriptionAdult"',4.8,794,1588,'70-1.jpg,70-2.jpg,70-3.jpg',NULL,5),(71,'Pacific Headwear Waxed Cotton Dad Cap',16.99,42,'"Waxed cotton
Low profile
Curved visor
Matching eyelets; Pro-stitched finish
Self-fabric strap with brass buckle clasp"',4.6,7,14,'71-1.jpg,71-2.jpg,71-3.jpg',NULL,5),(72,'Timberland Men`s Baseball',25,9534,'"Timberland Men`s baseball cap with leather strap
Adjustable leather strap closure
Curved Brim
Item package weight: 0.6 pounds"',4.5,1589,3178,'72-1.jpg,72-2.jpg,72-3.jpg',NULL,5),(73,'Timberland Men`s Cotton Canvas Baseball Cap',28,9888,'"Adjustable back strap
Curved brim
3D embroidered tree logo
Slide closure buckle
Special Size-Standard"',4.6,1648,3296,'73-1.jpg,73-2.jpg,73-3.jpg',NULL,5),(74,'Timberland Women`s Classic Tall Beanie',22.8,1398,'"COLD WEATHER HAT: Timberland Women`s Classic Tall Beanie, featuring logo on cuff.
...
COZY GIFT: An ideal gift for family, loved ones and friends for Christmas, Birthdays, Valentine`s Day, New Year’s Days, Wedding Anniversary, Thanksgiving, Holidays and more"',4.6,233,466,'74-1.jpg,74-2.jpg,74-3.jpg',NULL,5),(75,'Concept One U.s Polo Assn. Embroidered Pony Horse Logo Since 1890 Adjustable Cotton Baseball Hat with Curved Brim',19.99,1050,'"BASEBALL HAT: Officially licensed U.S Polo Association adjustable golf cap with an embroidered horse logo on the front
ONE SIZE FITS ALL: Features an adjustable silver metal buckle closure embossed with an American flag to allow for easy resizing for a comfortable fit on heads of all shapes and sizes
CURVED BRIM: Features a curved brim with stitching to keep the Sun`s UV rays out of your eyes
100% COTTON: Lightweight and durable cotton fabric allows for instant comfort when worn
HAND WASH ONLY: Recommended for hand washing only, lay flat to dry, do not iron"',4.5,175,350,'75-1.jpg,75-2.jpg,75-3.jpg',NULL,5),(76,'Under Armour Men`s Ignite Pro Slide, (002) Black/Red Fusion/Red Fusion, 11, US',29.67,270,'"Adjustable synthetic strap with soft foam lining for added comfort & perforations for breathability
...
Water Resistance Level: not_water_resistant"',4.2,45,90,'76-1.jpg,76-2.jpg,76-3.jpg',NULL,6),(77,'YOKI Women`s Heels Platform',39.99,168,'"Open Round Toe
Padded Inner Footbed
4"" Chunky Heel
Adjustable Upper Ankle Buckle Strap"',3.7,28,56,'77-1.jpg,77-2.jpg,77-3.jpg',NULL,6),(78,'Skechers Men`s Nampa Food Service Shoe',39.99,74124,'"Memory Foam Footbed
Relaxed Fit
Slip Resistant
Electrical Hazard
Food Service
Lace up duty
"',4.4,12354,24708,'78-1.jpg,78-2.jpg,78-3.jpg',NULL,6),(79,'Blowfish Malibu Unisex-Child Fashion Sneaker',33.22,18918,'"Velcro enclosure
Fabric linings
Manmade outsole
Canvas fabric upper with metal grommet accents"',4.6,3153,6306,'79-1.jpg,79-2.jpg,79-3.jpg',NULL,6),(80,'Columbia Men`s Bonehead PFG Boat Shoe
...
Combination open mesh and synthetic upper; Soft heel material for added comfort; Blood `n Guts water and stain resistant treatment"',4.5,501,1002,'80-1.jpg,80-2.jpg,80-3.jpg',NULL,6),(81,'Chooka Women`s Waterproof Plush Chelsea Bootie Chelsea Boot',41.99,39516,'"durable waterproof boots, fashion meets function with these ankle high booties. 100% waterproof with a fashionable matte finish
...
cleaning, use a damp cloth with water and soap to clean your boots"',4.3,6586,13172,'81-1.jpg,81-2.jpg,81-3.jpg','81.mp4',6),(82,'DUNLOP Protective Footwear MD0HD01.13 Dane, 100% Waterproof PVC, Lightweight and Durable Protective Footwear, Size 13, Black',28.95,3348,'"LIGHTWEIGHT: The Dane boots are made to be lightweight, up to 25% lighter than classic PVC boots.
...
DUNLOP PROTECTIVE FOOTWEAR: We are Dunlop Protective Footwear, the world’s leading manufacturer of protective footwear. In more than 75 countries worldwide, we provide comfortable and protective footwear for workers across multiple industries."',4.4,558,1116,'82-1.jpg,82-2.jpg,82-3.jpg',NULL,6),(83,'GUESS Women`s Avin Wedge Sandal',59.95,11970,'"Logo graphic straps elevated on a chunky platform heel lend warm-weather lift to casual style in the Avin sandals from GUESS.
Hook and Loop closure
Open Toe
Guess detailing on straps"',4.6,1995,3990,'83-1.jpg,83-2.jpg,83-3.jpg',NULL,6),(84,'"Crocs Unisex-Adult Classic Clogs
"',49.99,3410562,'"Crocs For Women And Men: The Crocs Classic Clogs Are Not Only The Most Comfortable Shoes For Women And Men But Also Easy To Clean Just Using Soap And Water And Allowing For A Quick Dry.
...
Pretty knotted bow detail"',4,2,4,'85-1.jpg,85-2.jpg,85-3.jpg',NULL,6),(86,'Reef Women`s Bliss Nights Flip-Flop
',23.39,67182,'"VEGAN LEATHER + RUBBER SOLE: The freshness of vegan leather paired with the comfort of the flexible sponge outsole keeps you on trend and your feet happy. The stylish design and versatility means you can seamlessly go from brunch to a walk on the beach.
...
Leather front outsole with traditional ballet shoe pleating for turning eas"',4.6,1475,2950,'87-1.jpg,87-2.jpg,87-3.jpg',NULL,6),(88,'Bloch Women`s Jason Samuels Smith Ballet Flat, Tap Dancing',220,5226,'"TAP SPECIFIC : Our Shoe is specifically designed for tap dancers, with a focus on producing clear and precise sounds. The shoe is engineered to achieve maximum tap plate contact with the floor for a crisp sound.
...
STYLISH and VERSATILE : The Jason Samuels Smith Dance Shoe for Women has a sleek and elegant design that is popular among serious dancers. The shoe is available in various colors and styles, making it easy for dancers to find one that suits their style and preferences."',4.7,871,1742,'88-1.jpg,88-2.jpg,88-3.jpg',NULL,6),(89,'Capezio Women`s Cadence Oxford',84.4,1170,'"Women: Begin with street shoe size - 1/2 size up. Men: Begin 2 sizes up from street shoe size.
...
Tapered heel, Scored rubber sole patch for traction"',4.5,195,390,'89-1.jpg,89-2.jpg,89-3.jpg',NULL,6),(90,'Capezio Girl`s Jr. Tyette Tap Shoe Dance',57.44,79866,'"PVC (black patent) and PU leather (caramel and white) uppers
