...
loadSearchRecommendation = () => {
    ...
    if (keyword.length > 0) {
        ...
        tenShop.append(`<a href="/viewSearchShop" class="ms-2 text-white text-start link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover w-100" >
                            ${keyword}
                        </a>`
        );
